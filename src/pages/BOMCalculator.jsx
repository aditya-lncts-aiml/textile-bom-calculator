...
export default function BOMCalculator() {
  ...
  const { fabricCost, accessoriesCost, otherCostTotal, subtotal, lowEstimate, highEstimate, perUnit } =
    useMemo(() => calculateSubtotal({
      ...
      lengthPerUnit,
      wastagePercent,
    }), [fabricMetersRequired, fabricPricePerMeter, accessories, quantity, otherCostPerUnit, lengthPerUnit, wastagePercent]);

  return (
    <div className="p-6 max-w-6xl mx-auto">
      <header className="mb-6">
        <h1 className="text-2xl font-bold">Textile BOM Calculator</h1>
        <p className="text-sm text-gray-600">Fabric & accessories estimation with ±5% tolerance.</p>
      </header>
